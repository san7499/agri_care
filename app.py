...
# Updated treatment suggestions with multiple options
treatment_suggestions = {
    'Pepper bell Bacterial spot': {
        'Fertilizer': [
            'Balanced NPK fertilizer',
            'Potassium-rich fertilizer for stronger stems'
        ],
        'Pesticide': [
    ...
    'Potato Late blight': {
        'Fertilizer': [
            'Balanced NPK fertilizer with phosphorus',
    ...
    'Tomato Bacterial spot': {
        'Fertilizer': [
            'Balanced NPK fertilizer',
            'Nitrogen-rich fertilizer for leaf growth'
        ],
        'Pesticide': [
            'Copper sprays',
